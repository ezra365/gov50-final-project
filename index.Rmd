...
ggplot(multiregression_summary, aes(x = term, y = estimate, fill = ifelse(p.value < 0.05, "Significant", "Not Significant"))) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_errorbar(aes(ymin = estimate - 1.96 * std.error, ymax = estimate + 1.96 * std.error), position = position_dodge(width = 0.8), width = 0.2) + #1.96 is a 95% CI
