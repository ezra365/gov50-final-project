...
many of the independent variabes, such as changing military alliances, 
geographic status,corruption, and production levels. I aim to do by measuring 
Average Treatment Effect (ATE) where applicable, linear regression, and multiple
...
has any stastistical significance. I'm going to do so by generating 1,000
...
# I am going to bootstrap seperately as one variable as numeric and the other dbl
...
countries may be statistically significant. Since the confidence interval does 
not include 0, we can reject the null hypothesis at the 0.1 significance level.
In other words, the observed difference in means (point estimate) falls within a
range of values that is unlikely to occur if the null hypothesis were true. 

Putting this into a social science context.
